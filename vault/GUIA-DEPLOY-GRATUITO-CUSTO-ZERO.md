...
### Opção A: Vercel (Recomendado pela simplicidade)
1. Crie uma conta gratuita em [vercel.com](https://vercel.com).
2. Conecte seu repositório Git ou instale a CLI: `npm i -g vercel`.
3. Na pasta do projeto:
   - **Root Directory:** `web`
   - **Framework Preset:** `Vite`
   - **Build Command:** `npm run build`
   - **Output Directory:** `dist`
4. Clique em **Deploy**. Sua aplicação estará online com certificado SSL automático (ex: `https://edital-audit.vercel.app`).
